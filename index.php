...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* ใช้ Flex เป็นตัวกำหนดพื้นที่แทนการหักความสูงแบบตายตัว */
        .chat-container {
            height: auto;
            min-height: 0;
...
<body class="flex w-full overflow-hidden bg-white">
    ...
    <?php if (!$is_logged_in): ?>
        <div class="login-screen fixed inset-0 bg-white flex flex-col items-center justify-center px-4 sm:px-6 z-[999]">
            <div class="w-24 h-24 p-2 bg-slate-50 border border-gray-100 rounded-[2rem] mb-6 flex items-center justify-center shadow-sm animate-bounce">
